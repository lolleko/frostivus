...
function OnStartTouch(data)
    ...
    if
        thisEntity.IsLumber and donkey:GetUnitName() == "npc_frostivus_lumber_drone" or
            donkey:GetUnitName() == "npc_frostivus_lumber_drone_flying"
     then
        donkey:AddNewModifier(donkey, nil, "modifier_frostivus_resource_carry", {IsLumber = true})
    elseif
        thisEntity.IsGold and donkey:GetUnitName() == "npc_frostivus_gold_drone" or
            donkey:GetUnitName() == "npc_frostivus_gold_drone_flying"
     then
