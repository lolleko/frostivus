LinkLuaModifier(
    "modifier_frostivus_roshan_immortality",
    "abilities/roshan/frostivus_roshan_immortality.lua",
        ...
        if data.unit == self:GetParent() then
            local aegis =
                ...
                "prop_dynamic",
                {
                    ...
                    origin = self:GetParent():GetOrigin(),
                    DefaultAnim = "aegis_idle"
                }
            )
