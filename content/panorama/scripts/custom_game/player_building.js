(function () {
    ...
    function UpdatePreview () {
      ...
      if (worldPos !== null) {
        ...
        GameEvents.SendCustomGameEventToServer('buildingCheckArea', { 'origin': worldPos, 'sizeX': sizeX, 'sizeY': sizeY })
  ...
  GameUI.SetMouseCallback(function( eventName, arg ) {
  	...
  	if ( eventName == "pressed" )
  	{
        ...
        if (blocked) {
          ...
          GameEvents.SendCustomGameEventToServer('buildingRequestConstruction', {'origin': worldPos, 'investmentName': investmentName, 'queue': queue})
          if (!queue) {
            StopPreview()
          }
        }
